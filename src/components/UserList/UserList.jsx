            ...
            <tbody>
              {users?.map((user) => (
                ...
                >
                  ...
                  <th
                    scope="row"
                    className="px-6 py-2 font-normal text-gray-900 whitespace-nowrap capitalize"
                  >
                    {user.name}
                  </th>
                  <td className="px-6 py-2 capitalize">{user.username}</td>
                    ...
                    {show && user.id === id ? (
                      <div className="absolute bg-white bottom-4 right-10 w-32 rounded-md shadow-md overflow-hidden">
                        <ul className="w-full flex items-center justify-start flex-col">
                          ...
                          <li className="w-full flex items-center text-[10px] px-2 py-1 capitalize hover:bg-gray-400/10">
                            <span className="mr-2">
                              <svg
                                width="14"
                                height="14"
              ...
              {/* <tr className="bg-white text-[12px] font-normal  hover:bg-gray-50">
                <td className="w-4 p-3">
                  <div className="flex items-center">
                    <input
                      type="checkbox"
                      className="w-4 h-4 text-slate-900 bg-gray-100 border-slate-900 rounded outline-none"
                    />
                  </div>
                </td>
                <th
                ...
                <td className="px-6 py-2 capitalize">koopman</td>
                <td className="px-6 py-2">femicymon@gmail.com</td>
                <td className="px-6 py-2">08103142141</td>
                <td className="px-6 py-2 relative">
                  ...
                  {show ? (
                    <div className="absolute bg-white bottom-4 right-10 w-32 rounded-md shadow-md overflow-hidden">
                      <ul className="w-full flex items-center justify-start flex-col">
                        <li className="w-full text-[10px] px-2 py-1 capitalize hover:bg-gray-400/10">
                          <Link className="w-full flex items-center capitalize">
                            <span className="mr-2">
                              <svg
                                width="16"
                                height="16"
